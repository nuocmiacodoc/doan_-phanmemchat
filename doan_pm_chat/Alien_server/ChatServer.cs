...
namespace Alien_server
{
    ...
    class ChatServer
    {
        ...
        public static void AddUser(TcpClient tcpUser, string strUsername)
        {
            ...
            SendAdminMessage(htConnections[tcpUser] + " đã vào phòng");
        }
        ...
        public static void RemoveUser(TcpClient tcpUser)
        {
            ...
            if (htConnections[tcpUser] != null)
            {
                ...
                SendAdminMessage(htConnections[tcpUser] + " đã rời phòng");
        ...
        public void StartListening()
        {
            ...
            tlsClient = new TcpListener(IPAddress.Any, 45000);
        ...
        private void AcceptClient()
        {
            ...
            if (currUser != "")
            {
                ...
                if (ChatServer.htUsers.Contains(currUser) == true)
                {
                    ...
                    swSender.WriteLine("0|Tên này đã tồn tại!");
                    swSender.Flush();
                    CloseConnection();
                    return;
                }
